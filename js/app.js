...
function columnValidation() {
	...
	for (var j = 0; j < 7; j++) {
		...
		// CandyCount es igual al número de elementos en Candy Position
...
// Añade la clase "eliminar" a "líneas de dulces" que se encuentran en columnas
...
// Valida si hay dulces que deben eliminarse en la fila
